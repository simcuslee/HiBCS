...
$startCount=($del-list-1)*$perNumber; //分页开始,根据此方法计算出开始的记录
...
?><div class="page"><?php if ($page == 1) {echo '<a href="http://'.$myurl.'"><strong>首页</strong></a>';}
if ($page != 1) {echo '<a href="http://'.$myurl.'/del-list-'.($page - 1).'"><strong>上一页</strong></a>';}
for ($i=1;$i<=$totalPage;$i++) {echo '<a href="http://'.$myurl.'/del-list-'.$i.'" class="pagelist">'.$i.'</a>';}
if ($page<$totalPage) {echo '<a href="http://'.$myurl.'/del-list-'.($page + 1).'" class="pagelist">下一页</a>';}
