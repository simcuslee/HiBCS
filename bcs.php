...
//if (in_array($ext, array('mp3'))) { $response = $baiduBCS->create_object ( $bucket, $object, $path ,$opt);} else { @unlink($attach['tmp_name']);echo '<!doctype html><html><head><meta charset="utf-8" /><meta name="robots,Baiduspider" content="noindex,noarchive,nofollow"><title>kooker BCS 专用上传</title></head><body><div><p>仅允许上传MP3！<br />Only allowed to upload MP3!<br />返回<a href="bcs.html">上传页</a></p></div></body></html>';} //仅允许上传某附件类型
