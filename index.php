...
if ($page != 1) {echo '<a href="http://'.$myurl.'/page-'.($page - 1).'"><strong>上一页</strong></a>';}
for ($i=1;$i<=$totalPage;$i++) {echo '<a href="http://'.$myurl.'/page-'.$i.'" class="pagelist">'.$i.'</a>';}
if ($page<$totalPage) {echo '<a href="http://'.$myurl.'/page-'.($page + 1).'" class="pagelist">下一页</a>';}
